    ...
    <div className="max-w-7xl mx-auto border-b flex items-center justify-between px-4 py-4 relative">
      ...
      <div className="flex items-center gap-4">
        <Link to={`/publish`}>
          <button
            type="button"
            className="mr-4 cursor-pointer text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center"
          >
            New
          </button>
        </Link>
